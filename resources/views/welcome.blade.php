  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-edit"></i> <span>Acceso</span>
              <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
            </a>
            <ul class="treeview-menu">
              <li><a href="../forms/general.html"><i class="fa fa-circle-o"></i> Administrar Usuarios</a></li>
              <li><a href="../forms/advanced.html"><i class="fa fa-circle-o"></i> Administrar Roles</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
              <li><a href="../tables/simple.html"><i class="fa fa-circle-o"></i> Reporte de Cupones</a></li>
              <li><a href="../tables/data.html"><i class="fa fa-circle-o"></i> Data Reporte de Canjeos</a></li>
            </ul>
          </li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Dashboard
          <small>Mire las estadisticas en graficos</small>
        </h1>
        <ol class="breadcrumb">
